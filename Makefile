...
SOURCES = \
	__init__.py \
	remote_renderer.py remote_renderer_dialog.py

PLUGINNAME = remote_renderer

PY_FILES = \
	__init__.py \
	remote_renderer.py remote_renderer_dialog.py

UI_FILES = remote_renderer_dialog_base.ui
...
QGISDIR=C:\Users\rotzr\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
